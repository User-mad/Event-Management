        ...
        <div class="breadcrumb">
                    <div class="container">
                        <ul>
                            ...
                            <li class="active"><a href="innerphotographer.php">Photographer</a></li>
                        </ul>
                    </div>
                </div>
                <div class="container">
                                ...
                                <div class="left-side">
                                    ...
                                    <div class="filter-view">
                                        ...
                                        <div class="title">
                                            ...
                                            <label ><a href="innerphotographer.php">    All </a></label>   </div>
                                            
                                            <div class="check-slide">
                                            <label ><a href="innerphotographer.php?price=30000">&lt; 30000 </a></label>   </div>
                                            <div class="check-slide">
                                            <label ><a href="innerphotographer.php?price=50000">&lt; 50000 </a></label>  </div>
                                            <div class="check-slide">
                                            <label ><a href="innerphotographer.php?price=100000">&lt; 100000 </a></label>  </div>
                                        ...
                                        <div class="filter-block">
                                            ...
                                            <div class="check-slide">
                                                <label ><a href="innerphotographer.php?type=Wedding">Wedding </a></label>
                                                
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="innerphotographer.php?type=Birthday"> Birthday </a></label>   </div>
                                            <div class="check-slide">
                                            <label ><a href="innerphotographer.php?type=Party"> Party </a></label>  </div>
</div>
                                    ...
                                    <div class="venues-slide last">
                                        ...
                                        <div class="text">
                                           ...
                                           <div class="button">
                                                ...
                                                <a href="innerviewphotographer.php?id=<?php echo $r['pid']; ?>"" class="btn">View Details</a>
                                                <a href="requestphotographer.php?id=<?php echo $r['pid']; ?>&pcost=<?php echo $r['price']; ?>&type=<?php echo $r['ptype']; ?>" class="btn">Request Booking</a>
                                            </div>
                                        </div>
