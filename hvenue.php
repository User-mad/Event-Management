        ...
        <div class="breadcrumb">
                    <div class="container">
                        <ul>
                            ...
                            <li class="active"><a href="hvenue.php">Venue</a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="left-side">
                                    ...
                                    <div class="filter-view">
                                        <div class="filter-block">
                                            ...
                                            <label  ><a href="hvenue.php"" >All </a></label>  
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="hvenue.php?type=Banquet Hall">Banquet Hall </a></label>  
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="hvenue.php?type=Lawn/Farmhouse">Lawn/Farmhouse </a></label> 
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="hvenue.php?type=Resort">Resort </a></label>  
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="hvenue.php?type=4 Star Hotel">4 Star Hotel </a></label>      
                                            </div>
                                        </div>
                                        ...
                                        <div class="filter-block">
                                            ...
                                            <div class="check-slide">
                                                <label ><a href="hvenue.php?capacity=100">&lt; 100 </a></label>
                                                
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="hvenue.php?capacity=200">&lt; 200 </a></label>   </div>
                                            <div class="check-slide">
                                            <label ><a href="hvenue.php?capacity=500">&lt; 500 </a></label>  </div>
                                            <div class="check-slide">
                                            <label ><a href="hvenue.php?capacity=1000">&lt; 1000 </a></label>  </div>
                        ...
                        ?>
                                    <div class="venues-slide last">
                                        ...
                                        <div class="text">
                                            ...
                                            <div class="button">
                                                <a href="hviewvenue.php?id=<?php echo $r['vid']; ?>" class="btn">    View Details    </a>
                                            </div>
                                        </div>
