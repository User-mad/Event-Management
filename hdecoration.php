        ...
        <div class="breadcrumb">
                    <div class="container">
                        <ul>
                            ...
                            <li class="active"><a href="hdecoration.php">Decoration</a></li>
                        </ul>
                    </div>
                </div>
                               ...
                               <div class="left-side">
                                   ...
                                   <div class="filter-view">
                                       <div class="filter-block">
                                           ...
                                           <label ><a href="hdecoration.php">All</a></label>  
                                           </div>
                                           <div class="check-slide">
                                           <label ><a href="hdecoration.php?type=Wedding">Wedding</a></label>  
                                           </div>
                                           <div class="check-slide">
                                           <label ><a href="hdecoration.php?type=Birthday">Birthday </a></label> 
                                           </div>
                                           <div class="check-slide">
                                           <label ><a href="hdecoration.php?type=Party">Party</a></label>  
                                           </div>
                       ...
                       ?>
                                   <div class="venues-slide last">
                                       ...
                                       <div class="text">
                                           ...
                                           <div class="button">
                                             <a href="hviewdecoration.php?id=<?php echo $r['id']; ?>"" class="btn">View Details</a>
                                           </div>
                                       </div>
