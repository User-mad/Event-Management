        ...
        <div class="breadcrumb">
                    <div class="container">
                        <ul>
                            ...
                            <li class="active"><a href="innercatering.php">Catering</a></li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="left-side">
                                    ...
                                    <div class="filter-view">
                                        ...
                                        <div class="title">
                                            ...
                                            <label ><a href="innercatering.php">All</a></label>  
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="innercatering.php?type=Wedding">Wedding</a></label>  
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="innercatering.php?type=Birthday">Birthday </a></label> 
                                            </div>
                                            <div class="check-slide">
                                            <label ><a href="innercatering.php?type=Party">Party</a></label>  
                                            </div>
                            ...
                            ?>
                                <div class="toolbar">
                                        ...
                                        <div class="right-tool">
                                            ...
                                            <div class="link">
                                                <ul>
                                                    <li><a href="innercatering.php?ftype=Veg">Veg</a></li>
                                                    <li><a href="innercatering.php?ftype=Non-Veg">Non-Veg</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text">
                                            ...
                                            <div class="outher-link">
                                             ...
                                             <div class="button">
                                                ...
                                                <a href="innerviewcatering.php?id=<?php echo $r['id']; ?>"" class="btn">View Details</a>
                                            </div>
                                        </div>
